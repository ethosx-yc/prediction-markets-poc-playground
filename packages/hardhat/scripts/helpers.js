...
const { prepareConditionAndRegister, mintCollateral, enableTrading, prepareOrder, registerTrades, getBalances, splitTokens, mergeTokens, reportPayouts, redeemPosition } = require("./scripts/helpers");
...
// maker2 splits 1000000 collateral tokens into yes and no tokens positions
